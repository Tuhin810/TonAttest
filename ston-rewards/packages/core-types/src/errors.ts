 ...
 */
export type StonRewardsErrorCode =
...
export class StonRewardsError extends Error {
  readonly code: StonRewardsErrorCode;
  readonly retryable: boolean;
  override readonly cause?: unknown;

  constructor(
    code: StonRewardsErrorCode,
    message: string,
    opts: { retryable?: boolean; cause?: unknown } = {},
  ) {
    super(message);
    this.name = "StonRewardsError";
    this.code = code;
...
const DEFAULT_RETRYABLE = new Set<StonRewardsErrorCode>([
  "PROVIDER_UNAVAILABLE",
  "PROVIDER_RATE_LIMITED",
  "POOL_REGISTRY_UNAVAILABLE",
  "STALE_ACTIVITY",
