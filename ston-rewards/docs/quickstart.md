...
```ts
import { StonRewards, swap } from "@ston-rewards/sdk";

const ston = new StonRewards({
  apiKey: process.env.STON_REWARDS_API_KEY!,
...
```ts
import { verifyAttestation } from "@ston-rewards/sdk";
