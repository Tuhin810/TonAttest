 ...
 */
import { TonAttestError, normalizeAddress } from "@tonattest/core-types";
import { PoolRegistry, TonapiProvider } from "@tonattest/data-provider";
import { StonFiRateProvider, resolveActivity } from "@tonattest/activity";
...
main(process.argv.slice(2))
  ...
  .catch((err: unknown) => {
    if (err instanceof TonAttestError) {
