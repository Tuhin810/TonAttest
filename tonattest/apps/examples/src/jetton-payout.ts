 ...
 *
 * Run it:
 *   TONATTEST_API_KEY=... TONATTEST_CAMPAIGN_ID=... \
 *   TONATTEST_PUBLIC_KEY=... APP_WALLET_MNEMONIC="..." \
 *   pnpm --filter @tonattest/examples jetton-payout <wallet>
 *
 ...
 */
import { TonAttest, verifyAttestation } from "@tonattest/sdk";

const API_KEY = requireEnv("TONATTEST_API_KEY");
const CAMPAIGN_ID = requireEnv("TONATTEST_CAMPAIGN_ID");
// Pinned at deploy time. Fetching this from the service you are verifying
// would make the offline check meaningless.
const PUBLIC_KEY = requireEnv("TONATTEST_PUBLIC_KEY");
