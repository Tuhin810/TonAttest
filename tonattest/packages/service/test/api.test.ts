...
import { verifyAttestation } from "@tonattest/attest";
import { swap } from "@tonattest/rules";
...
describe("observability", () => {
  ...
  it("exposes metrics in Prometheus format", async () => {
    ...
    expect(res.body).toContain("tonattest_verify_total");
    expect(res.body).toContain("tonattest_attestations_issued_total");
    expect(res.body).toContain("tonattest_verify_duration_seconds");
  });
