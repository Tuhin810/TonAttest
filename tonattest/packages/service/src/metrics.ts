...
export const METRIC = {
  verifyDuration: "tonattest_verify_duration_seconds",
  verifyTotal: "tonattest_verify_total",
  attestationsIssued: "tonattest_attestations_issued_total",
  providerErrors: "tonattest_provider_errors_total",
  unknownActions: "tonattest_unknown_actions_total",
  rateLimited: "tonattest_rate_limited_total",
  httpRequests: "tonattest_http_requests_total",
} as const;
