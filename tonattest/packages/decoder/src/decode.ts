...
import { pairKey, type PoolRegistrySnapshot, type RawAction, type RawEvent } from "@tonattest/data-provider";

/**
 * Raw provider events -> normalized STON.fi actions.
 *
 * This function is pure: `(events, registry, wallet) => actions`. All IO lives
 * in `@tonattest/data-provider`. That is what makes the golden-fixture
