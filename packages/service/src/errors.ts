import { StonRewardsError, type StonRewardsErrorCode } from "@ston-rewards/core-types";
 ...
 * produces both.
 */
const STATUS_BY_CODE: Record<StonRewardsErrorCode, number> = {
...
export function toApiError(error: unknown): ApiError {
  ...
  if (error instanceof StonRewardsError) {
