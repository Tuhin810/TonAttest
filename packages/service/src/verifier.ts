...
import type { DataProvider, PoolRegistrySnapshot } from "@ston-rewards/data-provider";
import { resolveActivity, type RateProvider } from "@ston-rewards/activity";
import { evaluate, type EvaluationResult } from "@ston-rewards/rules";
import {
  signAttestation,
  type Attestation,
  DEFAULT_TTL_SECONDS,
} from "@ston-rewards/attest";
